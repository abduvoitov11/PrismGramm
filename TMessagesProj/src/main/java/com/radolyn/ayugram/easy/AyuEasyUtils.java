...
public class AyuEasyUtils {
    ...
    public static void sendTextMessageSync(
        ...
        AndroidUtilities.runOnUIThread(() -> {
            SendMessagesHelper.SendMessageParams params = SendMessagesHelper.SendMessageParams.of(
                    message, peer, replyToMsg, replyToTopMsg, webPage, searchLinks, entities, null, null, notify, 0, 0, null, false
            );
    ...
    public static void sendDocumentMessageSync(
        ...
        var paramsMap = createParams(groupId, isFinalInGroup);

        AndroidUtilities.runOnUIThread(() -> {
            SendMessagesHelper.SendMessageParams params = SendMessagesHelper.SendMessageParams.of(
                    document, null, path, peer, replyToMsg, replyToTopMsg, caption, entities, null, paramsMap, notify, 0, 0, 0, null, null, false
            );
            helper.sendMessage(params);
        });
    ...
    public static void sendPhotoMessageSync(
        ...
        AndroidUtilities.runOnUIThread(() -> {
            SendMessagesHelper.SendMessageParams params = SendMessagesHelper.SendMessageParams.of(
                    photo, path, peer, replyToMsg, replyToTopMsg, caption, entities, null, paramsMap, notify, 0, 0, 0, null, false
            );
            helper.sendMessage(params);
        });
    ...
    public static void forwardMessagesSync(
        ...
        AndroidUtilities.runOnUIThread(() -> {
            long topMsgId = replyToTopMsg != null ? replyToTopMsg.getId() : 0;
            helper.sendMessage(messages, peer, forwardFromMyName, hideCaption, notify, scheduleDate, topMsgId);
        });
