...
public class AyuGramPreferencesActivity extends BasePreferencesActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    private void toggleLocalPremium() {
        ...
        org.telegram.tgnet.TLRPC.User currentUser = UserConfig.getInstance(currentAccount).getCurrentUser();
        if (currentUser != null) {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2:
                    ...
                    if (position == messageSavingBtnRow) {
                        ...
                        textCell.setTextAndIcon(LocaleController.getString(R.string.PrismaArchive), R.drawable.msg_archive, true);
                    } else if (position == mediaDownloaderRow) {
                        textCell.setTextAndIcon(LocaleController.getString(R.string.PrismaMediaDownloader), R.drawable.msg_download, true);
                    } else if (position == deletedMarkTextRow) {
                        ...
                        textCell.setTextAndValueAndIcon(LocaleController.getString(R.string.ClearAyuDatabase), AndroidUtilities.formatFileSize(size), R.drawable.msg_clear, true);
