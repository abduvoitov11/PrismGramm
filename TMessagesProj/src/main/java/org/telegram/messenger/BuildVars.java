...
public class BuildVars {
    ...
    // Krypton: qiymatlar BuildConfig orqali local.properties'dan olinadi
    // (git'ga hech qachon qo'shilmaydi). Qarang: local.properties.example
    public static int APP_ID = BuildConfig.KRYPTON_APP_ID;
    public static String APP_HASH = BuildConfig.KRYPTON_APP_HASH;
